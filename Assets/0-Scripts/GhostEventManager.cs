...
public class GhostEventManager : MonoBehaviour
{
    ...
    [SerializeField] GenericAccessMechanism downstairsSecretTV;
    ...
    [SerializeField] GenericAccessMechanism upstairsLoftDoor;
    ...
    [SerializeField] GenericAccessMechanism upstairsRedRoomDoor;
    ...
    public IEnumerator UpstairsLoftScare(int occurrence)
    {
        switch (occurrence)
        {
            case 1: // Player is near the mirror
                ...
                ResetAnimatorState();
                if (upstairsLoftDoor.state == GenericAccessMechanism.states.OPEN) goto DoorOpen;
